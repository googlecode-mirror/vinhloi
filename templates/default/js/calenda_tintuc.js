...
jQuery.jcalendar = function() {
    ...
    // render calendar
		...
		jQuery('div.main_jcalendar').html('<table cellspacing="1"></table><div class="jcalendar-links"></div>');
		jQuery('div.main_jcalendar table').append(headRow, tBody);
		jQuery('div.main_jcalendar > div.jcalendar-links').append(prevLink, todayLink, nextLink);
	};
...
jQuery.fn.jcalendar = function(a) {
    ...
    $('div.jcalendar-selects').after('<div class="main_jcalendar"></div>');
